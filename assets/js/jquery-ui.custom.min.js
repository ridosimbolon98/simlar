		...
		(t.widget = function (e, i, n) {
			...
			return (
				...
				(o.prototype = t.widget.extend(
					...
					u,
					{ constructor: o, namespace: d, widgetName: e, widgetFullName: s }
				)),
				r
		...
		(t.widget.bridge = function (e, n) {
			...
			t.fn[e] = function (r) {
				var o = "string" == typeof r,
					...
					u = this;
				return (
					(r = !o && a.length ? t.widget.extend.apply(null, [r].concat(a)) : r),
					o
						? this.each(function () {
								var i,
									n = t.data(this, s);
		...
		(t.Widget.prototype = {
			...
			option: function (e, i) {
				...
				if ("string" == typeof e)
					if (((o = {}), (n = e.split(".")), (e = n.shift()), n.length)) {
						for (
							s = o[e] = t.widget.extend({}, this.options[e]), r = 0;
							n.length - 1 > r;
							r++
						)
							(s[n[r]] = s[n[r]] || {}), (s = s[n[r]]);
			...
			_trigger: function (e, i, n) {
				...
				return (
					...
					!(
						(t.isFunction(o) &&
							o.apply(this.element[0], [i].concat(n)) === !1) ||
			...
			_mouseCapture: function (e) {
				...
				return this.helper ||
					...
					: ((this.handle = this._getHandle(e)),
					  this.handle
							? (t(s.iframeFix === !0 ? "iframe" : s.iframeFix).each(
									function () {
										t(
		...
		t.ui.plugin.add("draggable", "snap", {
			...
			drag: function (e, i, s) {
				...
				for (u = s.snapElements.length - 1; u >= 0; u--)
					(l = s.snapElements[u].left),
						(h = l + s.snapElements[u].width),
						(c = s.snapElements[u].top),
						...
						!t.contains(
							...
							: ("inner" !== f.snapMode &&
									...
									o &&
										(i.position.top =
											s._convertPositionTo("relative", { top: p, left: 0 })
												.top - s.margins.top),
									r &&
										(i.position.left =
											s._convertPositionTo("relative", {
							  ...
							  "outer" !== f.snapMode &&
									...
									n &&
										(i.position.top =
											s._convertPositionTo("relative", { top: c, left: 0 })
												.top - s.margins.top),
									o &&
										(i.position.top =
											s._convertPositionTo("relative", {
