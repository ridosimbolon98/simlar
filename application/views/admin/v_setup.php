      ...
      <form action="<?= base_url(); ?>admin/update_setup" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="trx" class="form-control" id="trx">
            <input type="text" name="trx" class="form-control" id="trx1" disabled>
          </div>
          <div class="form-group">
            <label for="tipe">Tipe</label>
            <input type="hidden" name="tipe" class="form-control" id="tipe">
            <input type="text" name="tipe" class="form-control" id="tipe1" disabled>
          </div>
          <div class="form-group">
